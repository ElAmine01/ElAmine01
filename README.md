...
Je suis étudiant en 3ème année de BUT Informatique à l'IUT d'Orléans.

Mes travaux se concentrent sur le développement full-stack d'applications web et la conception d'outils logiciels performants, avec des applications concrètes allant des plateformes de réservation au modding de jeux vidéo.
...
> Création d'un plugin ajoutant une mini-carte en jeu pour faciliter l'orientation du joueur. Analyse de la mémoire pour récupérer les coordonnées du véhicule en temps réel et injection de code dans le rendu. <br>
...
> Développement full-stack d'un site vitrine et d'une plateforme de réservation réalisés en stage. Intégration d'un chatbot relié à Trello et déploiement automatisé sur Cloudflare Pages. <br>
